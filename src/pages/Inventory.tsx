        ...
        fetch("/api/spin/inventory")
            ...
            .then((data) => {
                if (Array.isArray(data)) {
                    setItems(data.filter((item: InventoryItem) => {
                        const rarity = item.itemRarity?.toLowerCase();
        ...
        <div className="max-w-[1400px] mx-auto space-y-8 pb-20">
            ...
            {items.length === 0 ? (
                <div className="bg-[#111218]/80 border border-[#ffb700]/20 rounded-[24px] p-12 text-center">
                    <p className="text-gray-400 text-lg">ยังไม่มีไอเทมระดับ Legendary หรือ Mythic ในกระเป๋า</p>
                </div>
            ) : (
